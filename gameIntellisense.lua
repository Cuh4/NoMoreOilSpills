...
--- Called whenever an oil spill is created
--- @param tile_x number
--- @param tile_y number
--- @param delta number
--- @param total number
--- @param vehicle_id integer -1 if oil spill is updated by an addon or just oil tick updates
function onOilSpill(tile_x, tile_y, delta, total, vehicle_id) end
...
--- @class SWMatrix
--- @field [1] number sizeX
--- @field [2] number 
--- @field [3] number 
--- @field [4] number 
--- @field [5] number 
--- @field [6] number sizeY
--- @field [7] number 
--- @field [8] number 
--- @field [9] number 
--- @field [10] number
--- @field [11] number sizeZ
--- @field [12] number 
--- @field [13] number x
--- @field [14] number y
--- @field [15] number z
...
--- simulates a command, all addons pick it up in onCustomCommand(), useful for addon communication
--- @param command string command to simulate
function server.command(command) end
...
---@field object_type SWObjectTypeEnum The object type
...
--- Sets oil amount at location
--- @param transform_matrix SWMatrix
--- @param amount number
function server.setOilSpill(transform_matrix, amount) end

--- Returns amount of oil at target location
--- @param transform_matrix SWMatrix
---@return number oilAmount
...
--- Sets the tooltip of a character/creature
--- @param object_id number The object_id of the character/creature
--- @param display_name string The text to put in the tooltip
...
--- @param transform_matrix SWMatrix
--- @param magnitude number magnitude 0->1
--- @param causeTsunami boolean whether the meteor will cause a tsunami upon impact
--- @return boolean is_success 
function server.spawnMeteorShower(transform_matrix, magnitude, causeTsunami) end

--- @param transform_matrix SWMatrix
--- @param magnitude number magnitude 0->1
--- @param causeTsunami boolean whether the meteor will cause a tsunami upon impact
--- @return boolean is_success 
function server.spawnMeteor(transform_matrix, magnitude, causeTsunami) end
